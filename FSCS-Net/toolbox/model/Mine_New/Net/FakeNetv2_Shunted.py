...
from Backbone.Shunted.SSA import shunted_s
...
class EnDecoderModel(nn.Module):
    def __init__(self, n_classes=8, backbone='segb2'):
        ...
        if backbone == 'segb2':
            self.backboner = shunted_s()
            self.backboned = shunted_s()

        # [64, 128, 320, 640]
        # [64, 128, 320, 512] Segformer
        # [64, 128, 256, 512] shunted
        ...
        self.f4_p = perviseHead(256, n_classes)
        self.f3_p = perviseHead(128, n_classes)
        self.f2_p = perviseHead(64, n_classes)

        self.mlpdecoder = DecoderHead(in_channels=[64, 128, 256, 512], num_classes=8)
